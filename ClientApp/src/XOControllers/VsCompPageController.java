...
import static XOGame.OfflinePage.playOfflineLabel;
import static XOGame.OfflinePage.user1;
import static XOGame.OfflinePage.user2;
...
public class VsCompPageController extends VsCompPage{
    ...
    public void setOfflineLabelToPlayerTurn() {
        ...
        if (currentPlayer.equals("X")) {
            playOfflineLabel.setText(playerX + "'s turn (X)");
        } else {
            playOfflineLabel.setText(playerO + "'s turn (O)");
        }
    }
