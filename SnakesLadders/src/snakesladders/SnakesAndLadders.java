...
public class SnakesAndLadders extends AnchorPane {
    ...
    public SnakesAndLadders() {
        ...
        avatar1ImageView = new ImageView(new Image(getClass().getResource("/media/avatar1.png").toExternalForm()));
        avatar1ImageView.setFitWidth(60);
        avatar1ImageView.setFitHeight(60);

        avatar2ImageView = new ImageView(new Image(getClass().getResource("/media/avatar2.png").toExternalForm()));
